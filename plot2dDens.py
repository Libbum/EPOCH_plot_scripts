'''
Plots 2D files, density and laser.
...
ay = np.zeros(fdata['Magnetic Field/Bz'].data.shape)
az = np.zeros(fdata['Magnetic Field/By'].data.shape)
a = np.zeros(fdata['Magnetic Field/By'].data.shape)
